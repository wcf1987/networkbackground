...
@Mapper
public interface BuiltNodeMapper {
    public static String TbaleName="t_builtnode";
    //增加一个Person
    ...
    int insert(BuiltNodeEntity entity);
    ...
    List<BuiltNodeEntity> searchByName(String name,Integer uid);
}
