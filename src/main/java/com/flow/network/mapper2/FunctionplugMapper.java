...
@Mapper
public interface FunctionplugMapper {
    public static String TbaleName="t_functionplug";
    //增加一个Person
    ...
    int insert(FunctionplugEntity entity);
    ...
    List<FunctionplugEntity> searchByName(String name,Integer uid);
}
