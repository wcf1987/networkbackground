...
public class PackageController {
    ...
    public ApiResponse delete(@RequestBody PackageEntity detailEntity) {
    ...
    @PostMapping("/add")
    public ApiResponse add(@RequestBody PackageEntity detailEntity){
        serviceImp.add(detailEntity);
        return ApiResponse.success();
    }
    @PostMapping("/update")
    public ApiResponse update(@RequestBody PackageEntity detailEntity){
