...
import com.flow.network.service2.OptionListServiceImp;
...
public class OptionListController {
    @Autowired
    private OptionListServiceImp serviceImp;
    ...
    public ApiResponse delete(@RequestBody OptionListEntity detailEntity) {
        //List<InterfaceEntity> u = new ArrayList<>();
    ...
    @PostMapping("/add")
    public ApiResponse add(@RequestBody OptionListEntity detailEntity){
        serviceImp.add(detailEntity);
        return ApiResponse.success();
    }
    @PostMapping("/update")
    public ApiResponse update(@RequestBody OptionListEntity detailEntity){
